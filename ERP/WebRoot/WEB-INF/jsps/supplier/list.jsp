			...
			<div class="square-o-top">
				<table width="100%" border="0" cellpadding="0" cellspacing="0"
					...
					<tr>
						...
						<td width="8%">供应商:</td>
						<td width="17%">
							<s:textfield name="sqm.name" size="18"></s:textfield>
						</td>
						<td width="8%">联系人:</td>
						<td width="17%">
							<s:textfield name="sqm.contact" size="18"></s:textfield>
						</td>
						<td width="12%">
					...
					<tr>
						...
						<td>电话:</td>
						<td>
							<s:textfield name="sqm.tele" size="18"></s:textfield>
						</td>
						<td>提货方式：</td>
						<td>
						<s:select list="@cn.brotherChun.erp.invoice.supplier.vo.SupplierModel@needsMap" headerKey="-1" headerValue="----请-选-择----" name="sqm.needs" cssClass="kuan"/>
						</td>
						<td>
						...
						<td>
							...
							<span style="line-height:12px; text-align:center;"> 
								<s:a action="supplier_input" cssClass="xiu">
									<s:param name="sm.uuid" value="uuid"></s:param>
									修改
								</s:a>
							</span> 
