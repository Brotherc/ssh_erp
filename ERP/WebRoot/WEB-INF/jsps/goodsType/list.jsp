			...
			<div class="square-o-top">
				<table width="100%" border="0" cellpadding="0" cellspacing="0"
					...
					<tr>
						...
						<td width="62">供应商:</td>
						<td width="142">
							<s:select list="supplierList" headerKey="-1" headerValue="----请-选-择----" listKey="uuid" listValue="name" name="gtqm.supplier.uuid" cssClass="kuan"/>
						</td>
						<td width="60">类别名称:</td>
						<td width="149">
							<s:textfield name="gtqm.name" size="18"/>
						</td>
						...
						<td>
							...
							<span style="line-height:12px; text-align:center;"> 
								<s:a action="goodsType_input" cssClass="xiu">
									<s:param name="gtm.uuid" value="uuid"/>
									修改
								</s:a>
							</span> 
