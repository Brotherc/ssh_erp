			...
			<div class="square-order">
				...
				<table width="100%" border="1" cellpadding="0" cellspacing="0">
					...
					<s:iterator value="order.orderDetails">
						<tr align="center" bgcolor="#FFFFFF">
							<td height="30">${goods.gtm.name }</td>
							<td>${goods.name }</td>
							<td>${num }</td>
						</tr>
					</s:iterator>
				...
				<table width="100%">
					<tr>
						...
						<s:if test="order.type == @cn.brotherChun.erp.invoice.order.vo.OrderModel@ORDER_TYPE_OF_BUY_BUYING">
							<s:a action="transport_endTasks" cssStyle="color:#0f0;font-size:20px;padding-top:2px;font-weight:bold;text-decoration:none;width:82px;height:28px;display:block;background:url(images/btn_bg.jpg)">
								结&nbsp;&nbsp;单
								<s:param name="order.uuid" value="order.uuid"></s:param>
							</s:a>
						</s:if>
						<s:else>
