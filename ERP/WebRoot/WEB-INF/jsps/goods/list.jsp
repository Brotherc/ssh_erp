			...
			<div class="square-o-top">
				<table width="100%" border="0" cellpadding="0" cellspacing="0"
					...
					<tr>
						<td>供应商:</td>
						<td>
							<s:select list="supplierList" cssClass="kuan" headerKey="-1" headerValue="----请-选-择----" name="gqm.gtm.supplier.uuid" listKey="uuid" listValue="name"/>
						</td>
				...
				<table width="100%" border="1" cellpadding="0" cellspacing="0">
					...
					<s:iterator value="goodsList">
						<tr align="center" bgcolor="#FFFFFF">
							<td width="13%" height="30">${gtm.supplier.name }</td>
							<td>${name }</td>
							<td>${producer }</td>
							<td>${origin }</td>
