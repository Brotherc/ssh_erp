			...
			<div class="square-o-top">
				<table width="100%" border="0" cellpadding="0" cellspacing="0"
					...
					<tr>
						...
						<td width="60">所属菜单</td>
						<td width="149">
							<s:select list="parentMenuList" cssClass="kuan" headerKey="-1" headerValue="----请-选-择----" listKey="uuid" listValue="name" name="mqm.parent.uuid"/>
						</td>
						...
						<td>
							...
							<span style="line-height:12px; text-align:center;"> 
								<s:a action="menu_input" cssClass="xiu">
									<s:param name="mm.uuid" value="uuid"></s:param>
									修改
								</s:a> 
							</span> 
