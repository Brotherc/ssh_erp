			...
			<div class="square-o-top">
				<table width="100%" border="0" cellpadding="0" cellspacing="0"
					...
					<tr>
						...
						<td><s:textfield size="14" name="eqm.userName"></s:textfield></td>
						<td>真实姓名</td>
						<td><s:textfield size="14" name="eqm.name"></s:textfield></td>
						<td>电&nbsp;&nbsp;&nbsp;&nbsp;话</td>
						<td><s:textfield size="14" name="eqm.tele"></s:textfield></td>
						<td>性&nbsp;&nbsp;&nbsp;&nbsp;别</td>
						<td>
							<s:select list="@cn.brotherChun.erp.auth.emp.vo.EmpModel@genderMap" headerKey="-1" headerValue="----请-选-择----" name="eqm.gender" cssClass="kuan"></s:select>
						</td>
					...
					<tr>
						...
						<td><s:textfield size="14" name="eqm.email"></s:textfield></td>
						<td>出生日期</td>
						<td>
						...
						<td>部门名称</td>
						<td>
							<s:select list="depList" listKey="uuid" listValue="name" cssClass="kuan" headerKey="-1" headerValue="----请-选-择----" name="eqm.dep.uuid"></s:select>
						</td>
