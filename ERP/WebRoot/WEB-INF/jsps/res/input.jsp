...
<div class="content-right">
	...
	<div class="content-text">
		<div class="square-order">
			<form action="res_save.action" method="post">
			<s:hidden name="res.uuid"></s:hidden>
				...
				<table width="100%"  border="0" cellpadding="0" cellspacing="0">
				    <tr  bgcolor="#FFFFFF">
				      ...
				      <td width="82%" colspan="3">
				      	<s:textfield name="res.name" size="77"></s:textfield>
				      </td>
				    </tr>
				    <tr bgcolor="#FFFFFF">
					  <td colspan="4">&nbsp;</td>
				    ...
				    <tr  bgcolor="#FFFFFF">
				      ...
				      <td width="82%" colspan="3">
				      	<s:textfield name="res.url" size="77"></s:textfield>
				      </td>
				    </tr>
				    <tr bgcolor="#FFFFFF">
					  <td colspan="4">&nbsp;</td>
