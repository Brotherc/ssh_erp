...
<div class="content-right">
	...
	<div class="content-text">
		<form action="res_list.action" method="post">
			<div class="square-o-top">
				<table width="100%" border="0" cellpadding="0" cellspacing="0"
					...
					<tr>
						...
						<td width="123">
							<s:textfield name="resQ.name" size="18"></s:textfield>
						</td>
						<td width="68" height="30">资源值</td>
						<td width="123">
							<s:textfield name="resQ.url" size="18"></s:textfield>
						</td>						
						...
						<td>
							...
							<span style="line-height:12px; text-align:center;"> 
								<s:a action="res_input.action" cssClass="xiu">
									<s:param name="res.uuid" value="uuid"></s:param>
									修改
								</s:a>
							</span> 
