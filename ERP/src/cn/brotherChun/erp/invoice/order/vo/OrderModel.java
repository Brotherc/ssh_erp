package cn.brotherChun.erp.invoice.order.vo;
...
public class OrderModel {
	...
	private static final String ORDER_ORDERTYPE_OF_BUY_VIEW="采购";
	private static final String ORDER_ORDERTYPE_OF_RETURN_BUY_VIEW="销售";
	private static final String ORDER_ORDERTYPE_OF_SALE_VIEW="采购退货";
	private static final String ORDER_ORDERTYPE_OF_RETURN_SALE_VIEW="销售退货";
	...
	private static final String ORDER_TYPE_OF_BUY_NO_CHECK_VIEW="未审核";
	private static final String ORDER_TYPE_OF_BUY_CHECK_PASS_VIEW="通过";
	private static final String ORDER_TYPE_OF_BUY_CHECK_NO_PASS_VIEW="驳回";
	private static final String ORDER_TYPE_OF_BUY_BUYING_VIEW="采购中";
	private static final String ORDER_TYPE_OF_BUY_IN_STORE_VIEW="入库中";
	private static final String ORDER_TYPE_OF_BUY_COMPLETE_VIEW="结单";
	
	public static final Integer ORDER_TYPE_OF_SALE_NO_CHECK=211;
	public static final Integer ORDER_TYPE_OF_SALE_CHECK_PASS=221;
	
	private static final String ORDER_TYPE_OF_SALE_NO_CHECK_VIEW="未审核";
	private static final String ORDER_TYPE_OF_SALE_CHECK_PASS_VIEW="通过";
	...
	static{
		...
		saleMap.put(ORDER_TYPE_OF_SALE_CHECK_PASS, ORDER_TYPE_OF_SALE_CHECK_PASS_VIEW);
